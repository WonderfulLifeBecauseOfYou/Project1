...
public class Monster2 : MonoBehaviour
{
    ...
    public float walkDistance;//巡逻距离
    ...
    {
        if(distance <= walkDistance && distance > followDistance)
        {
            RaycastHit2D hit1 = Physics2D.Raycast(transform.position, moveDirection, walkDistance, LayerMask);//这一条看玩家有没有进入警戒范围
            Debug.DrawRay(transform.position, moveDirection * walkDistance, Color.red);
