...
public class HomeShopManager : MonoBehaviour
{
    //singletone pattern
    public static HomeShopManager current;
    ...
    private void Load()
    {
        ...
        ShopItem[] items = Resources.LoadAll<ShopItem>("HomeShop");
        
        //initialize the dictionary
        shopItems.Add(ObjectType.建筑, new List<ShopItem>());
        shopItems.Add(ObjectType.地形, new List<ShopItem>());
        shopItems.Add(ObjectType.植物, new List<ShopItem>());
        shopItems.Add(ObjectType.景观, new List<ShopItem>());
        shopItems.Add(ObjectType.动物, new List<ShopItem>());
